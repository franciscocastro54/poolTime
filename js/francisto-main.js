...
function productconfigclose() {
    document.getElementById('productList').parentNode.removeChild(document.getElementById(' t'))
...
const cronometro = (nombreMesa, index)=> setInterval(function(){
    ...
    if ( segundos == 0 ) {
        ...
        document.querySelector('div#mesas  div.card:nth-child(1) #total').innerHTML = `Total: $ ${MesaList[`${nombreMesa}`].Total }`
        if (minutos < 10) { minutos = "0"+minutos }
    }
    document.querySelector('div#mesas  div.card:nth-child(1) #cobro').innerHTML = `Tiempo: ${minutos} min ${segundos} seg`
},1000)
